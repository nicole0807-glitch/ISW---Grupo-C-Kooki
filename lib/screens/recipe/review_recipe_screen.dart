  ...
  Future<void> _processValidation(String newStatus) async {
    ...
    if ((newStatus == 'rechazado' || newStatus == 'requiere_cambio') && 
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Debes dejar un comentario para rechazar o solicitar cambios."),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        actions: [
          IconButton(icon: const Icon(Icons.visibility, color: Color(0xFF61896F)), onPressed: () {}),
        ],
      ),
      body: Stack(
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Text("Validation Checklist", 
                    style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ),
                _buildChecklist(),
                const Padding(
                  padding: EdgeInsets.fromLTRB(16, 24, 16, 8),
                  child: Text("Reviewer Notes", 
                    style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ),
                _buildNotesField(),
              ],
  ...
  Widget _buildChecklist() {
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            _buildCheckItem("Nutritional value accuracy", "Calories and macros match ingredients", 
              _accuracyChecked, (val) => setState(() => _accuracyChecked = val!)),
            _buildCheckItem("Photo quality & compliance", "High resolution, no watermarks", 
              _photoChecked, (val) => setState(() => _photoChecked = val!)),
            _buildCheckItem("Instructions clarity & safety", "Steps are easy to follow and safe", 
              _clarityChecked, (val) => setState(() => _clarityChecked = val!)),
            _buildCheckItem("Allergen labeling correctness", "Tags match listed ingredients", 
              _allergenChecked, (val) => setState(() => _allergenChecked = val!)),
          ],
        ),
      ),
    );
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: "Add specific feedback for the author...",
          filled: true,
          ...
          children: [
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: _isSubmitting ? null : () => _processValidation('aprobado'),
                icon: const Icon(Icons.check_circle),
                label: const Text("Approve Recipe", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              ),
            ),
              ...
              children: [
                Expanded(
                  child: OutlinedButton.icon(
                    ...
                    onPressed: _isSubmitting ? null : () => _processValidation('rechazado'),
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    ...
                    onPressed: _isSubmitting ? null : () => _processValidation('requiere_cambio'),
                    icon: const Icon(Icons.edit_note),
                    label: const Text("Revise", style: TextStyle(fontWeight: FontWeight.bold)),
                  ),
                ),
              ],
            ),
