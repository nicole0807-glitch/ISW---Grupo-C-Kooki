...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _login() async {
    ...
    try {
      // 15 seconds global timeout for login process
      ...
      if (loginResult['success'] == true && mounted) {
        ...
        // Establecemos el rol directamente ahorrando una consulta a la BD
        homeController.setRoleInfo(
          loginResult['roleId'] as int,
          loginResult['roleName'] as String?,
        );
      ...
      if (mounted) {
        ...
        if (errorStr.contains('timeout')) {
          displayMsg = 'La conexión tardó demasiado. Revisa tu internet.';
