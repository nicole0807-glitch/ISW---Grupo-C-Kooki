...
class HomeController extends ChangeNotifier {
  ...
  /// Permite establecer el rol directamente desde el login para evitar consultas redundantes
  void setRoleInfo(int id, String? name) {
    _roleId = id;
    _roleName = name;
    isLoading = false;
    notifyListeners();
    print("✅ Rol establecido manualmente: $_roleId ($name)");
  }
